          ...
          <div className="two-col">
            ...
            >
              ...
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '14px', color: 'rgba(255,255,255,0.5)', textAlign: 'center', marginTop: '1.5rem' }}>
                Prefer WhatsApp?{' '}
                <a href="https://chat.whatsapp.com/Injfr54fvz5GYDnz4fnuLf?s=cl&p=i&mlu=4&ilr=4" target="_blank" rel="noopener noreferrer" style={{ color: GOLD, textDecoration: 'none' }}>
          ...
          >
            ...
            <div style={{ gridColumn: 'span 1' }} className="retirement-footer-brand">
              ...
              <div style={{
                ...
                />
                <button
                  onClick={() => window.open('https://chat.whatsapp.com/Injfr54fvz5GYDnz4fnuLf?s=cl&p=i&mlu=4&ilr=4', '_blank')}
            ...
            <div>
              ...
              <nav style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {[
                  ...
                  { label: 'Book a Call', href: 'https://chat.whatsapp.com/Injfr54fvz5GYDnz4fnuLf?s=cl&p=i&mlu=4&ilr=4' },
