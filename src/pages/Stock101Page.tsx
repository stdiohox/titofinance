...
const footerSocials: { label: string; href: string; Icon: IconType }[] = [
  ...
  { label: 'WhatsApp', href: 'https://chat.whatsapp.com/GqAp7dMusRoDhUPEFU6QKL?s=cl&p=i&mlu=4&ilr=4', Icon: FaWhatsapp },
]
...
const footerConnect: { label: string; href: string; external?: boolean }[] = [
  { label: 'Book a Call', href: 'https://chat.whatsapp.com/GqAp7dMusRoDhUPEFU6QKL?s=cl&p=i&mlu=4&ilr=4', external: true },
