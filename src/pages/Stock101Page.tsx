...
const footerSocials: { label: string; href: string; Icon: IconType }[] = [
  ...
  { label: 'WhatsApp', href: 'https://chat.whatsapp.com/LGD9xagBy2Y4PjF7BCdp2n?mode=gi_t', Icon: FaWhatsapp },
]
      ...
      <MotionConfig reducedMotion="user">
        ...
        >
          ...
          >
            ...
            <a
              href="https://chat.whatsapp.com/LGD9xagBy2Y4PjF7BCdp2n?mode=gi_t"
              target="_blank"
