      ...
      <div className="max-w-[88rem] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          <button
            ...
            style={{ background: '#2D5A27', color: 'white', fontFamily: 'DM Sans, sans-serif', fontSize: '0.95rem', fontWeight: 500, paddingLeft: '1.75rem', paddingRight: '0.375rem', paddingTop: '0.5rem', paddingBottom: '0.5rem' }}
