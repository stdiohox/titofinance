      ...
      <div className="max-w-[88rem] mx-auto">
        ...
        <div data-cards className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <a href="https://chat.whatsapp.com/GqAp7dMusRoDhUPEFU6QKL?s=cl&p=i&mlu=4&ilr=4" target="_blank" rel="noopener noreferrer" className="mt-auto" style={{
              fontFamily: 'DM Mono, monospace',
              fontSize: '11px',
              color: '#C9A84C',
              textTransform: 'uppercase',
          ...
          >
            ...
            <div>
              ...
              <a href="https://chat.whatsapp.com/GqAp7dMusRoDhUPEFU6QKL?s=cl&p=i&mlu=4&ilr=4" target="_blank" rel="noopener noreferrer" style={{
                fontFamily: 'DM Mono, monospace',
                fontSize: '11px',
                color: '#C9A84C',
                textTransform: 'uppercase',
